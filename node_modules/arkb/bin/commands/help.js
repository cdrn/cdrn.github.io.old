...
const command = {
    ...
    execute: async (args) => {
        ...
        console.log(utils_1.parseColor(colors, figlet_1.default.textSync('ARKB', 'Whimsy'), 'yellow'));
        console.log(`Usage: arkb ${utils_1.parseColor(colors, '[options]', 'cyan')} ${utils_1.parseColor(colors, '[command]', 'green')}\n`);
        ...
        const opts = Array.from(options)
            ...
            const arg = opt.arg ? utils_1.parseColor(colors, ` <${opt.arg}>`, 'blackBright') : '';
        ...
        const cmds = Array.from(commands)
            ...
            if (cmd.args && cmd.args.length > 0) {
                for (const a of cmd.args) {
                    arg += utils_1.parseColor(colors, ` <${a}>`, 'blackBright');
                }
            }
