...
const command = {
    ...
    execute: async (args) => {
        ...
        if (!commandValues || !commandValues.length) {
            console.log(utils_1.parseColor(colors, 'Wallet path is required.', 'redBright'));
            return;
        }
        ...
        try {
            ...
            console.log(utils_1.parseColor(colors, 'Wallet saved!', 'green'));
        }
        catch (e) {
            console.log(utils_1.parseColor(colors, 'Invalid wallet file.', 'red'));
            if (debug)
                console.log(e);
        }
    },
