...
class Transfer {
    ...
    async execute(target, amount, feeMultiplier = 1) {
        ...
        tx.addTag('User-Agent-Version', utils_1.getPackageVersion());
        ...
        try {
            ...
            if ((await this.blockweave.wallets.jwkToAddress(this.wallet)) !== feeTarget) {
                ...
                if (feeTarget.length) {
                    ...
                    feeTx.addTag('App-Version', utils_1.getPackageVersion());
    ...
    async withdrawBundler(bundler, amount) {
        ...
        const hash = await arbundles_1.deepHash([
            buffer_1.stringToBuffer(data.currency),
            buffer_1.stringToBuffer(data.amount.toString()),
            buffer_1.stringToBuffer(data.nonce.toString()),
        ]);
