    ...
    return async (source) => {
        ...
        function prepareChunkUploadPayload(chunkIndex, chunkData) {
            ...
            return {
                ...
                data_path: buffer_1.bufferTob64Url(proof.proof),
                offset: proof.offset.toString(),
                chunk: buffer_1.bufferTob64Url(chunkData),
            };
        }
        await promises_1.pipeline(source, stream_chunker_1.default(merkle_1.MAX_CHUNK_SIZE, { flush: true }), 
        ...
        async function (chunkedSource) {
            ...
            for await (const chunkData of chunkedSource) {
                ...
                const chunkValid = await merkle.validatePath(txChunkData.data_root, parseInt(chunkPayload.offset, 10), 0, parseInt(chunkPayload.data_size, 10), buffer_1.b64UrlToBuffer(chunkPayload.data_path));
                if (!chunkValid) {
                ...
                activeChunkUploads.push(exponential_backoff_1.backOff(() => blockweave.api.post('chunk', chunkPayload), {
