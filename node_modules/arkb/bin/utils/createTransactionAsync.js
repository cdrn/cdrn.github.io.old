...
function createTransactionAsync(attributes, blockweave, jwk) {
    return async (source) => {
        const chunks = await promises_1.pipeline(source, generateTransactionChunksAsync_1.generateTransactionChunksAsync());
        ...
        tx.chunks = chunks;
        tx.data_root = buffer_1.bufferTob64Url(chunks.data_root);
        return tx;
    };
}
